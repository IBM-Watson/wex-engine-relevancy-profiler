...
import com.ibm.wex.relevancyprofiler.metrics.MeanReciprocalRankOfExpectedResults;



public class MeanReciprocalRankOfExpectedResultsTest extends RelevancyMetricsTest {

	@Before
	public void setUp() {
		initializeMetric(new MeanReciprocalRankOfExpectedResults());
		super.setUp();
	}
	...
	@Test
	public void shouldReturn05WhenOnlyExpectedResultIsSecond() {
