...
import com.ibm.wex.relevancyprofiler.metrics.NormalizedDiscountedCumulativeGainOfExpectedResults;



public class NormalizedDiscountedCumulativeGainOfExpectedResultsTest extends RelevancyMetricsTest {

	@Before
	public void setUp() {
		initializeMetric(new NormalizedDiscountedCumulativeGainOfExpectedResults());
		super.setUp();
	}
	...
	public void shouldReturn06WhenOnlyExpectedResultIsSecond() {
		...
		Assert.assertEquals(0.63, getMetric().calculate(getSession()), getDelta());
	}
